...
async function startSearch() {
    ...
    // set search results panel div as global variable
    ...
    if (locationNotValid || keywordNotValid) {
        ...
        if (locationNotValid) {
            displayErrorText.innerHTML = `Please enter a valid location`;
        }
        if (keywordNotValid) {
            displayErrorText.innerHTML = `Please enter a valid keyword`;
        }
        if (locationNotValid && keywordNotValid) {
            displayErrorText.innerHTML = `Please enter a valid location and keyword`;
        }
